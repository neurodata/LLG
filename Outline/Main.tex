...
\end{subfigure}
\caption{Example illustrating the SBM. (a) Probability matrix that follows a SBM with K = 7 blocks; (b) Adjacency matrix for 1000 vertices generated from the SBM with probability matrix in (a).}
