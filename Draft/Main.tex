...
This leads to the fact that the optimal embedding dimension will increase, making $\bar{A}$ and $\hat{P}$ closer together, moving the relative efficiency towards unity.
\end{remark}
