...
Note that this simulation only focus on the rank-2 setting primarily for the interpretability.
...
We omit confidence intervals for the estimated relative efficiencies since all confidence intervals (calculated by assuming a normal distribution) had lengths less than $0.015$, indicating that all relative efficiencies, aside from the relative efficiency for the CPAC200 atlas at $M=10$, are very different from 1.
