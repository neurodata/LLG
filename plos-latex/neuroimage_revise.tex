...
Here, we consider the same 2-block SBM as in Fig.~\ref{fig:RErho}. To be clear, we restate the parameters here:
\begin{equation*}
B = \begin{bmatrix}
0.42 & 0.2 \\
0.2 & 0.7
...
These screeplots shows the eigenvalues of the mean graph of all 454 graphs with diagonal augmentation in decreasing algebraic order for three atlases.
}
\label{fig:screeplot}
\end{figure}
