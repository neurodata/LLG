...
\caption{{\bf Comparison of MSE of $\hat{P}$ and $\bar{A}$ for three atlases at three sample sizes for the CoRR data.}
...
On the other hand, the relative efficiency $\mathrm{RE}(\bar{A},\hat{P})$ is lower for this synthetic data analysis then for the CoRR data.}
